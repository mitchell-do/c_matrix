...
START_TEST(test_sub_simple) {
  ...
  ck_assert_int_eq(
      s21_sub_matrix(&first_matrix, &second_matrix, &result_matrix), OK);
...
START_TEST(test_sub_simple_minus_sec_matrix) {
  s21_matrix first_matrix;
  s21_matrix second_matrix;
  s21_matrix result_matrix;
  s21_matrix expected_result;
...
START_TEST(test_sub_simple_minus_fir_matrix) {
  s21_matrix first_matrix;
  s21_matrix second_matrix;
  s21_matrix result_matrix;
  s21_matrix expected_result;
...
START_TEST(test_sub_number_error_null_matrix) {
  s21_matrix result_matrix;
  s21_matrix temp;
  ck_assert_int_eq(s21_create_matrix(2, 2, &temp), OK);

  ck_assert_int_eq(
      s21_sub_matrix((s21_matrix *)NULL, (s21_matrix *)NULL, &result_matrix),
      ERROR_INCORRECT_MATRIX);
  ck_assert_int_eq(s21_sub_matrix((s21_matrix *)NULL, &temp, &result_matrix),
                   ERROR_INCORRECT_MATRIX);
  ck_assert_int_eq(s21_sub_matrix(&temp, (s21_matrix *)NULL, &result_matrix),
                   ERROR_INCORRECT_MATRIX);
  ck_assert_int_eq(s21_sub_matrix(&temp, &temp, (s21_matrix *)NULL),
                   ERROR_INCORRECT_MATRIX);
...
Suite *test_s21_sub_matrix_suite(void) {
  ...
  tcase_add_test(tc, test_sub_simple_minus_fir_matrix);
  tcase_add_test(tc, test_sub_simple_minus_sec_matrix);
  tcase_add_test(tc, test_sub_number_error_null_matrix);
